...
/**MODAL */
    $('.edit').on('click', function () {
        ...
        var nameUser = $(this).closest('tr').find('td.nameUser').html();
        var cityUser = $(this).closest('tr').find('td.cityUser').html();
        var dobUser = $(this).closest('tr').find('td.dobUser').html();
        var emailUser = $(this).closest('tr').find('td.emailUser').html();

        $('.nameUser', myModal).val(nameUser);
        $('.cityUser', myModal).val(cityUser);
        $('.dobUser', myModal).val(dobUser);
        $('.emailUser', myModal).val(emailUser);
